...
public class Attack {
    ...
    public void useAttack(PokemonModel attackingPokemon, PokemonModel defendingPokemon,
            BattleOperationsManager battleOperationsManager, TurnEffectManager turnEffectManager) {
        this.damage = this.damageCalc(attackingPokemon, defendingPokemon, battleOperationsManager, turnEffectManager);
        isUsed = true;
    }

    private int damageCalc(PokemonModel attackingPokemon, PokemonModel defendingPokemon,
            BattleOperationsManager battleOperationsManager, TurnEffectManager turnEffectManager) {
        ...
        int critChance = battleOperationsManager.getCritChance(move, this.attacker, attackingPokemon, defendingPokemon);
        ...
        if (movePower > 0 && isCrit) {
            ...
            if (attackingPokemon.ability != null && attackingPokemon.ability.abilityId == 97) {
                otherModifiers *= 2.25f;
            } else {
                otherModifiers *= 1.5f;
            }
